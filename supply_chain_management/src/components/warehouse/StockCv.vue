        ...
        <div class="bg-white border border-slate-200 rounded-[24px] p-8 shadow-sm">
            <div class="flex items-center justify-between mb-8 pb-6 border-b border-slate-50">
                <div class="flex items-center gap-4">
                    ...
                    <h3 class="text-lg font-bold text-slate-800">Daftar Stok Pabrik - CV</h3>
                </div>
            ...
            <DataTable v-model:filters="filters" :value="stokList" :globalFilterFields="['nama_item']"
                ...
                <template #empty>
                    <div class="text-center py-20">
                        ...
                        <p class="text-slate-400 font-medium">Data stok CV kosong atau barang tidak ditemukan.</p>
                    </div>
                </template>
            </DataTable>
        </div>
...
const fetchStokCV = () => {
    const dataLokal = JSON.parse(localStorage.getItem('mock_stokCV')) || []
